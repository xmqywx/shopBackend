      ...
      return new Promise((resolve, reject) => {
        ...
        initData(this.url, this.getQueryParame()).then(data => {
          ...
          data.content.forEach((item) => {
            console.log(item)
            if (item.userDTO) {
              if (item.userDTO.erpLevel === 0 ) {
                item.userDTO.price = 'aPrice'
              }
              if (item.userDTO.erpLevel === 1 ) {
                item.userDTO.price = 'bPrice'
              }
              if (item.userDTO.erpLevel === 2 ) {
                item.userDTO.price = 'cPrice'
              }
              if (item.userDTO.erpLevel === 3 ) {
                item.userDTO.price = 'dPrice'
              }
              if (item.userDTO.erpLevel === 4 ) {
                item.userDTO.price = 'ePrice'
              }
            }
          })
