<template>
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="150px">
      ...
      <el-form-item label="停止接单">
        <el-radio v-model="form.stop_order_status" :label="1">停止</el-radio>
        <el-radio v-model="form.stop_order_status" :label="0">正常运行</el-radio>

      </el-form-item>
      <el-form-item label="联系客服">
        <el-input v-model="form.shop_phone" style="width: 370px;" />
      </el-form-item>
      <el-form-item label="">
...
export default {
  ...
  created() {
    get().then(rese => {
      ...
      this.form.stop_order_status = parseInt(this.form.stop_order_status)
    })
  },
  methods: {
    checkPermission,
