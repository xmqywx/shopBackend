    ...
    <el-card :bordered="false">
      <el-form  ref="formValidate" :rules="ruleValidate" :model="formValidate" label-width="130px" >
        <el-row :gutter="24">
          ...
          <!-- 单规格表格-->
          <el-col :xl="23" :lg="24" :md="24" :sm="24" :xs="24" v-show="false" >
          <!-- <el-col :xl="23" :lg="24" :md="24" :sm="24" :xs="24" v-if="formValidate.spec_type === 0"> -->
            <el-form-item >
              <el-table :data="oneFormValidate"  size="small" style="width: 90%;">
                ...
                <!-- <el-table-column prop="price" label="售价" v-show="false" align="center">
                  <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.price"/>
                  </template>
                </el-table-column>
                <el-table-column prop="cost" label="成本价" v-show="false" align="center">
                  <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.cost"/>
                  </template>
                </el-table-column>
                <el-table-column prop="ot_price" label="原价" v-show="false" align="center">
                  <template slot-scope="scope">
                ...
                <!-- <el-table-column prop="weight" label="重量（KG）" v-show="false" align="center">
                  <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.weight"/>
                  </template>
                </el-table-column>
                <el-table-column prop="volume" label="体积(m³)" v-show="false" align="center">
                  <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.volume"/>
                  </template>
                </el-table-column> -->
                <!-- <el-table-column prop="volume" label="所需兑换积分" v-show="false" align="center">
                  <template slot-scope="scope">
...
<!--                </el-table-column>-->
            ...
            <el-form-item label="商品属性：" v-if="false">
              <el-table :data="manyFormValidate" size="small" style="width: 90%;">
                <el-table-column prop="imageArr" label="图片" align="center">
                  <template slot-scope="scope">
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          add(this.formValidate).then(async res => {
            ...
            setTimeout(() => {
              this.$router.push({ path: '/shop/goods', query: this.$route.query });
            }, 500);
          }).catch(res => {
            // this.$message({
            //   message:res.message,
